...
const permissionTypesData = [
  ...
  },
  {
    ...
    "active": true,
    "description": "Permiso por el tiempo indispensable para el cumplimiento de un deber inexcusable de carácter público o personal."
  },
  {
  ...
  },
  {
    ...
    "requiresApproval": false,
    "active": true,
    "description": "Permiso para la realización de exámenes prenatales y técnicas de preparación al parto."
  },
  {
    ...
    "requiresApproval": false,
    "active": true,
    "description": "Permiso por fallecimiento, accidente o enfermedad grave de un familiar hasta segundo grado."
  },
  {
  ...
  },
  {
    ...
    "requiresApproval": false,
    "active": true,
    "description": "Ausencia por enfermedad o accidente que no da lugar a incapacidad temporal (menor de cuatro días)."
  },
  {
    ...
    "requiresApproval": true,
    "active": true,
    "description": "Solicitud de cambio de turno con otro compañero. (El cuadrante mostrará el turno final)."
  }
];
