...
export function initializeAddMarkedDateModal() {
    ...
    if (closeButton) {
        ...
        console.warn("Botón de cierre (.close-button) no encontrado en el modal de añadir fecha marcada.");
    }
    ...
    appliesToSelect = form.querySelector('#marked-date-applies-to-select');

    if (!dateInput || !typeSelect || !titleInput || !descriptionTextarea || !appliesToSelect) {
